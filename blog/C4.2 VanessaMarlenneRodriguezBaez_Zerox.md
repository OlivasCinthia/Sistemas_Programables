...
**En este codigo se logra obtener la IP ya que se conecta el ES32 por WIFI y con eso te genera la IP para ingresar a la pagina web la cual tiene un titulo que dice Mi primer Servidor Web basandonos en eso se le agregara el boton que se mostrara el codigo en el siguiente apartado**
