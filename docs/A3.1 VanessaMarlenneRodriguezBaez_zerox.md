...
| Numero | Condición 1       | Condición 2 | Indicar si el objeto es detectado o no detectado? |
| ------ | ---------------- | -------------------- | -------------------- | -------------------- | --------------------- |
...
5. Una vez completados puntos anteriores, agregue a la imagen del circuito anterior, un Display I2C 16x2 LCD.

6. Al haber completado la integración del Display I2C, ajuste el programa que le permita a traves del display mostrar el siguiente mensaje, "Objetivo detectado a ? cm , y en caso de no lograr la detección indicar el mensaje "Objetivo fuera de rango"
