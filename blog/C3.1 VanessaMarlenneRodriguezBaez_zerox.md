 ...
 * Basado en el circuito y en el código ingresado en el Arduino, el led se prende y se apaga cada segundo ya que es el tiempo que se le dio en el código, con el delay se le agrega el tiempo, se podria decir que es como una luz intermitente.
